...
<head>
    ...
    <title>FYGroup | Importación MSC</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Programación de Importación MSC</h1>
                    <p class="mb-4">Acá puedes revisar el horario de Importación de naves MSC.</p>
                        ...
                        <div class="col-lg">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Importación MSC</h6>
                                </div>
  ...
  $.ajax({
    ...
    if(x == 'OK'){
      Swal.fire({
        ...
        window.location = '<?php echo generateMkey('program_import_msc'); ?>';
      });
    } else {
      Swal.fire({
        title: 'Oops...',
