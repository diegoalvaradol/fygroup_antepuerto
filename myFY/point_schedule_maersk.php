        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid-custom">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Itinerarios Punto a Punto Maersk</h1>
                    <p class="mb-4">Acá puedes revisar los itinerarios punto a punto de Maersk.</p>
  ...
  $.ajax({
    ...
    if(x == 'OK'){
      Swal.fire({
        ...
        window.location = '<?php echo generateMkey('point_schedule_maersk'); ?>';
      });
    } else {
      Swal.fire({
        title: 'Oops...',
