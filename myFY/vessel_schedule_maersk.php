...
<head>
    ...
    <title>FYGroup | Itinerarios Naves Maersk</title>
                        ...
                        <div class="col-lg">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div style="display:flex; justify-content:center; padding-top:2%; padding-bottom:2%;">
                                    <iframe src="https://www.maersk.com/schedules/vesselSchedules" width="1250" height="600" style="border: none;"></iframe>
                                </div>
  ...
  $.ajax({
    ...
    if(x == 'OK'){
      Swal.fire({
        ...
        window.location = '<?php echo generateMkey('vessel_schedule_maersk'); ?>';
      });
    } else {
      Swal.fire({
        title: 'Oops...',
