...
<body id="page-top">
    ...
    <div id="editShipModal" style="display:none; position:fixed; width: 80%; top:10%; left:50%; transform:translateX(-50%);background:#fff; border-radius:10px; padding:20px; z-index:999; box-shadow:0 0 10px rgba(0,0,0,0.3);">
  ...
  $.ajax({
    ...
    if(x == 'OK'){
      Swal.fire({
        ...
        window.location = '<?php echo generateSecureLink('enter_ship'); ?>&page=' + paginaActual;
      });
    } else {
      Swal.fire({
        title: 'Oops...',
