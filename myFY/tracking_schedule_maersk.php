        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Tracking Maersk</h1>
                    <p class="mb-4">Acá puedes revisar el seguimiento en línea de contenedores asignados a Maersk.</p>
                        ...
                        <div class="col-lg">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Búsqueda de Tracking</h6>
                                </div>

                                <div style="display:flex; justify-content:center; padding-top:2%; padding-bottom:2%;">
                                    <iframe src="https://www.maersk.com/tracking/" width="1250" height="600" style="border: none;"></iframe>
                                </div>
  ...
  $.ajax({
    ...
    if(x == 'OK'){
      Swal.fire({
        ...
        window.location = '<?php echo generateMkey('tracking_schedule_maersk'); ?>';
      });
    } else {
      Swal.fire({
        title: 'Oops...',
