        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Programación de Stacking MSC</h1>
                    <p class="mb-4">Acá puedes revisar el stacking de naves MSC que recalarán en Coquimbo.</p>
                        ...
                        <div class="col-lg">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="text-center">
                                    <img src="../img/logo-msc.png" style="width:5%;">
