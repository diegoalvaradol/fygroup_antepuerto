...
<head>
  ...
  <title>SSL | Formulario de Registro</title>
  ...
  <style>
    ...
    /* Ajustes para pantallas menores a lg (992px) */
    @media (max-width: 991.98px) {
      /* Mostrar columna izquierda siempre y con espacio abajo */
      .col-lg-5 {
      ...
      <div class="col-xl-10 col-lg-10 col-md-12">
        <div class="card o-hidden border-0 shadow-lg my-5 glass-card">
          <div class="card-body p-0">
            <div class="row">
              <!-- Lado izquierdo con imagen e info (SIEMPRE visible) -->
                ...
                <div class="p-5">
                  ...
                  <form id="registerForm">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="run" name="run" oninput="formatearRut(this)"
                        maxlength="12" onblur="validaRut(this.value), verifyRun(this.value)" placeholder="12.345.678-9" />
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="email" name="email" onblur="verifyEmail(this.value)"
                    ...
                    <button type="button" name="saveuser" class="btn btn-primary btn-user btn-block" onclick="saveUser()">
                      <i class="fas fa-solid fa-check-circle"></i> Registrar
                    </button>
                  </form>
                  ...
                  <div class="text-center mt-3">
                    ...
                    <a href="login.php" class="btn btn-outline-info btn-sm m-1">
        ...
        if (x == 'NOOK') {
          Swal.fire({
            ...
            text:
              'El correo ' +
              email +
              ' ya se encuentra registrado, inicia sesión pinchando el link de abajo.',
            icon: 'error',
            showConfirmButton: false,
            footer:
              '<a class="small" href="login.php" style="font-size: medium;">¡Inicia sesión acá!</a><br><a class="small" href="forgot_password.php" style="font-size: medium;">¿Olvidaste la contraseña?</a>',
          }).then((result) => {
            $('#email').val('');
          });
        }
