...
<head>
  ...
  <title>SSL | Recuperar Contraseña</title>
              ...
              <div class="col-lg-7 col-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">
                      Lo entendemos, a veces pasan cosas. Solo introduce tu correo electrónico a continuación y te
                  ...
                  <form class="form-container" id="resetForm">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="email" name="email"
                        aria-describedby="emailHelp" onblur="validaEmail(this.value)"
  ...
  <script>
    var resetPassword = function () {
      ...
      $.ajax({
        ...
        if (x == 'OK') {
          ...
          Swal.fire({
            title: 'Oops...',
            text: 'Tu correo no está asociado a una cuenta de SSL.',
            icon: 'error',
            cancelButtonColor: '#d33',
          });
        }
    ...
    var validaEmail = function (email) {
      ...
      if (email == '') {
        Swal.fire({
          title: 'Oops...',
          text: 'Debe ingresar una dirección de correo electrónico.',
          icon: 'error',
          cancelButtonColor: '#d33'
        });
      } else {
