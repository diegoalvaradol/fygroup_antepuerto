...
if (!$archivos) {
  ...
  echo '<p style="text-align:center;margin-top:50px;">No existen una planificación naviera para mostrar..</p>';
  exit;
}
...
<iframe src="<?=htmlspecialchars($ruta)?>#toolbar=0&navpanes=0&scrollbar=0"></iframe>
